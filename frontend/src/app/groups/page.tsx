...
import { staggerContainer, listItemAnimation, unifiedButtonPress, unifiedCardInteraction } from '@/lib/animations';
...
function GroupsListPage() {
  ...
  return (
    <div className="min-h-screen bg-secondary pb-20 md:pb-6">
      ...
      <PullToRefresh onRefresh={loadGroups} disabled={loading}>
